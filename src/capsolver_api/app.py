...
async def turnstile_solver(url: str, website_key: str, headless: bool = True, browser_type: str = "camoufox"):
    res = await get_turnstile_token(url, website_key, headless=headless, browser_type=browser_type)
